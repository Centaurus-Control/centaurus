...
The default repository URL uses public HTTPS access:

```env
REPO_URL="https://github.com/Centaurus-Control/centaurus.git"
```

This does not require a GitHub login while the repository is public. SSH URLs can still be used when the target host has an appropriate deploy key configured.
